    ...
    cfg( cfg )
{
	...
	ui->comboBoxHackedLen->insertItem( hli++, "fft4k x avg10", QVariant(4096 * (unsigned)sizeof(short) * 10) );
	ui->comboBoxHackedLen->insertItem( hli++, "fft4k x avg20", QVariant(4096 * (unsigned)sizeof(short) * 20) );
